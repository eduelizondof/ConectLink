...
function getPlatformIcon(platform: string) {
    return platformIcons[platform] || faLink;
}
    ...
    <div class="rounded-xl border bg-card p-6 space-y-4">
        ...
        <div v-if="profile.social_links?.length" class="space-y-2">
            ...
            >
                ...
                >
                    <font-awesome-icon :icon="getPlatformIcon(link.platform)" class="h-5 w-5 text-white" />
                </div>
        ...
        <div v-else class="text-center py-8 text-muted-foreground">
            <font-awesome-icon :icon="faGlobe" class="h-12 w-12 mx-auto mb-3 opacity-50" />
                ...
                <form @submit.prevent="submitAdd" class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            ...
                            >
                                <font-awesome-icon :icon="getPlatformIcon(key)" class="h-5 w-5" />
